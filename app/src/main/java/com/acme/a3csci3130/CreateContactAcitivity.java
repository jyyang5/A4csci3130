...
public class CreateContactAcitivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // businessNum name primrayBusiness address  provience;

        //nameField = (EditText) findViewById(R.id.name);
        //emailField = (EditText) findViewById(R.id.provience);
    }
    /**
     * Initialization of Contact without parameters
     *
     * @param v   current viewer
     *
     */
    public void submitInfoButton(View v) {
        ...
        Contact person = new Contact(personID,businessNum, name,primrayBusiness,address, provience);
